...
- I asked llms about what would be considered the canonical way of doing something (which I didn't always agree with and did further research anyways)
- I used llms to make the documentation look nicer, on occasion change the wording.
...
## Architecture
- TCP server using Python's socket library with a simple HTTP protocol (`GET`, `PUT`, `DELETE`)
